<template>
    <app-layout title="Bienvenida">
        <div class="bg-cover bg-no-repeat bg-right-top xl:bg-bottom" style="background-image: url('https://www.creative-tim.com/learning-lab/tailwind-starter-kit/img/ill_header_3.png');"><!-- Start Hero Block --> 
            <div class="container mx-auto px-5 pb-16 sm:pb-16 lg:pb-24 xl:pb-32">
                <div class="mt-16 space-y-8 lg:mt-24 xl:mt-28">
                    <div class="space-y-4">
                        ...
                        <p class="max-w-sm text-lg text-gray-700 md:max-w-md md:text-xl">Recopilamos números de la suerte para usted basados en patrones de ganancia de alta frecuencia.</p>
                    </div>
                    <div class="space-y-4">
                        <a :href="route('register')" class="w-full px-8 py-3.5 mr-1 transition duration-300 bg-green-500 hover:bg-green-600 shadow text-white font-semibold rounded-lg sm:w-auto">Registro</a>
                        <a :href="route('login')" class="w-full px-8 py-3.5 transition duration-300 bg-blue-500 hover:bg-blue-600 shadow text-white font-semibold rounded-lg sm:w-auto">Ingresar</a>
                    </div>
                </div>
            </div>
        </div><!-- End Hero Block -->
